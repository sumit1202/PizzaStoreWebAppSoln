namespace PIzzaStoreModelLibrary
{
    public class Pizza : IEquatable<Pizza>, IComparable<Pizza>
    {
        ...
        /// <summary>
        /// When reference of Pizza object is used for printing, this method will print the details of
        /// the properties
        /// </summary>
        /// <returns>String that hold details of pizza name, price, quantity and type</returns>
        ...
        /// <summary>
        /// Checks if 2 Pizza objects are equal based on the ID of the Pizza
        /// </summary>
        /// <param name="other">Takes the pizza object that has to be compared</param>
